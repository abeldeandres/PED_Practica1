...
import EstructurasDeDatos.lineales.ArrayPila;
...
public class PED_G09_P1A {
    ...
    public static <E extends Comparable<E>> void elementoMenor(ArrayPila<E> arrayPila) {
        elementoMenorRec(arrayPila, arrayPila.tope());
    }
    ...
    public static <E extends Comparable<E>> E elementoMenorRec(ArrayPila<E> arrayPila, E minimo) {
        E minimoAbsoluto;
        ...
        //Mientras la pila no este vacia, iremos desapilando y almacenando el elemento en una variable local llamada "dato"
            ...
            minimoAbsoluto = elementoMenorRec(arrayPila, minimo);
    ...
    public static void main(String[] args) throws IOException {
        int opcion;
        ArrayPila<Integer> arrayPila = null;
        boolean salir = false;
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 1:
                    arrayPila = new ArrayPila<Integer>();
                    ...
                    if (!pilaCreada) {
                        ...
                        do {
                            ...
                            if (numero == -1) {
                                ...
                                arrayPila.apilar(new Integer(numero));
                            }
                        ...
                        if (arrayPila.esVacia()) {
                            ...
                            System.out.println(arrayPila.toString());
                ...
                case 5:
                    ...
                    if (!pilaConContenido) {
                        ...
                        if (!arrayPila.esVacia()) {
                            ...
                            int entero = leerInt();
                            arrayPila.replicarElemento(entero);
